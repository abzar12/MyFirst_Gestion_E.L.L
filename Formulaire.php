...
<html lang="en">
  ...
  <form action="FormulaireRET.php" method="post" style="display: flex;justify-content: center; align-item:center;">
          <div class="principal" >
                 <h3 class="text-uppercase" style="text-align:center; border-bottom: 1px outset rgba(189, 185, 185, 0.5); font-weight:bolder; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">Inscription</h3>
                  <div class="part" style="display:flex;">
                    <div class="part1">
                        ...
                        <input class="input" type="text" id="nom" name="nom" placeholder="Taper votre Nom" require><br> 
                        <label for="email" >Email</label><br>
                        <input class="input" type="email" name="email" id="email" placeholder="@gmail.com" require><br>
                        <label for="tel" >Telephone</label><br>
                        <input class="input" type="tel" name="tel" id="tel" placeholder="+233 XXXXXXXXX" require><br>
                        <label for="date">Date de Naissance</label><br>
                        <input class="input" type="date" name="date" id="date" require><br>
                        <label for="langue" >Langue préférée</label><br>
                        <input class="input" type="text"  name="langue" list="langue" require><br>
                        <datalist class="input" id="langue">
                            <option value="Français" selected>
                            <option value="Arabe">
                        </datalist>
                        <label for="pays" >Pays</label><br>
                        <input class="input" type="text" list="pays" name="pays" require>
                    ...
                    <div class="part2">
                        ...
                        <input type="text" name="prenom" id="prenom" placeholder="Taper votre Nom" require><br>
                        ...
                        <input type="tel" name="telWhatsapp" id="telWhatsapp" placeholder="+233 XXXXXXXXX" require><br>
                        <label for="dure">Durée</label>
                        <select name="dure" id="dure" require>
                        ...
                        <input type="text" id="ville" name="ville" require><br>
              ...
              <div class="part3" style="margin-top: auto; margin-left: 0; ">
                  <input type="checkbox" name="contrat" id="contrat" class="a1">
                      ...
                      <input type="submit" value="envoyer" class="button" name="button">
                </div>
