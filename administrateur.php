            ...
            <div class="ac_etudiant row">
                <div class="menu_etud">
                    <?php if ($userRole === 'Staff' || $userRole === 'Director') : ?>
                        <a href="AddAdmin.php"><button type="button"><ion-icon name="add-circle-outline"></ion-icon>Add Admin</button></a>
                    <?php endif; ?>
                        ...
                        <tr>
                            ...
                            <?php if ($userRole === 'Staff' || $userRole === 'Director') { ?>
                                <td class="tablebutton">
                                    <a href="modifyAdmin.php?code=<?= htmlspecialchars($row['ID']); ?>"><button type="submit"> <ion-icon name="create-sharp"></ion-icon></button></a>
                                    <form method="POST">
