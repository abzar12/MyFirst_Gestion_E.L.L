...
<head>
  ...
  <link rel="stylesheet" href="inputNormal.css">
</head>
      ...
      <div class="principale container">
        <div class="part2 active">
          <div class="">
            ...
            <h5 class="text-uppercase">InscriptionRRRRRR</h5>
          </div>
          <div class="partA">
            <div class="partiAA">
              <div class="colA1">
        ...
        <div class="part2 ">
          <div class="partB">
            ...
            <input type="checkbox" name="contrat" id="contrat" required class="input">
              <label for="contrat">D'accord pour les termes de condition</label> <br>
            <div class="PartiButton">
