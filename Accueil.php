  ...
  <header class="banner">
          ...
          <ul class="navbar-nav navbar-navdrop">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-dark bg-transparent" aria-labelledby="navbarDarkDropdownMenuLink">
                ...
                <li><a class="dropdown-item" href="Cmarketing.php">Digital Marketing</a></li>
              </ul>
            </li>
          </ul>
    ...
    <div class="ac_Acontainer ">
      <div class="A row col-12 ">
        ...
        <a href="Formulaire.php" class="ac_link link text-uppercase "> Inscrire</a>
      </div>
    </div>
  </header>
  <!-- le corps de la page  -->
  ...
  <section class="ac_2colum">
    <div class="container-fluid ">
      <div class="ac_col row ">
        <div class="ac_col1 col m-2 " data-aos="fade-right">
          <ion-icon class="ion-icon1" name="book"></ion-icon>
          <h2>Certificat accrédité</h2>
          <p>Nos programmes de formation délivrent des certificats accrédités, témoignant de votre maîtrise de la langue anglaise.</p>
        </div>
        ...
        <div class="ac_col3 col m-2" data-aos="fade-left">
          ...
          <p>Nos enseignants agréés sont des experts dévoués à vous guider vers la maîtrise de l'anglais. Faites équipe avec l'excellence.
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="ac_col row ">
        ...
        <div class="col-md-6">
          <div class="card-body" style="text-align:start;">
            ...
            <ul>
              <div style="background-color:rgba(43, 43, 43, 0.47);  color:black;font-weight:bold; margin:15px 25px 10px 5px; text-align:start;padding:25px 10px 10px 30px; border-radius:10px;" data-aos="fade-right"><ion-icon name="logo-ionic" style="color:black; margin:0px; padding:0px;"></ion-icon>
                <p class="card-text" style="margin:-25px 0px 0px 35px; padding:0px; text-align:start;">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor quas repudiandae eaque libero sapiente perspiciatis eos ex debitis et, ipsa tenetddur maxime quam voluptas reprehenderit.</p>
              </div>
              <div style="background-color:rgba(43, 43, 43, 0.47); color:black;font-weight:bold; margin:5px -10px 0px 35px; text-align:start;padding:25px 10px 10px 30px; border-radius:10px;" data-aos="fade-left"><ion-icon name="logo-ionic" style="color:black; margin:0px; padding:0px;"></ion-icon>
                <p class="card-text" style="margin:-25px 0px 0px 35px; padding:0px; text-align:start;">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor quas repudiandae eaque libero sapiente perspiciatis eos ex debitis et, ipsa tenetddur maxime quam voluptas reprehenderit</p>
              </div>
              <div style="background-color:rgba(43, 43, 43, 0.47); color:black;font-weight:bold; margin:15px 25px 10px 5px; text-align:start;padding:25px 10px 10px 30px; border-radius:10px;" data-aos="fade-right"><ion-icon name="logo-ionic" style="color:black; margin:0px; padding:0px;"></ion-icon>
